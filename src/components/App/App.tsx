...
const AboutPage = lazy(
  () => import("../../containers/AboutContainer/AboutContainer")
);
const ResumePage = lazy(
  () => import("../../containers/ResumeContainer/ResumeContainer")
);
const ArticlesPage = lazy(
  () => import("../../containers/ArticlesContainer/ArticlesContainer")
);
const ArticlePage = lazy(
  () => import("../../containers/ArticleContainer/ArticleContainer")
);

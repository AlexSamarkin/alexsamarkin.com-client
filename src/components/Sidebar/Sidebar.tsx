      ...
      <div className="sidebar box shadow pb-0 sticky-column">
        ...
        <div className="text-center">
          <div className="text-md-center">
            <LangSwitcher
              langs={[Locale.RU, Locale.EN]}
              activeLang={lang}
              onChange={onLangChange}
            />
          </div>
          <h3 className="title title--h3 sidebar__user-name">
            <span className="weight--500">{t("captions.alexander")}</span>{" "}
            {t("captions.samarkin")}
          </h3>
          ...
          <div className="social">
            <SocialLink
              link={"https://www.instagram.com/alex.samarkin"}
              icon={"icon-instagram"}
            />
            <SocialLink
              link={"https://www.github.com/AlexSamarkin"}
              icon={"icon-github"}
            />
            <SocialLink
